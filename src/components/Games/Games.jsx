  ...
  return (
    <div className='whole-section overflow-hidden w-screen h-auto'>
        ...
        <div className='main-game flex flex-col overflow-y-visible h-auto md:flex-row gap-[2em]'>
            <div className='image1 bg-white rounded-lg drop-shadow-[0_10px_10px_rgba(0,0,0,0.75)] flex flex-col gap-[1rem] md:gap-0 overflow-hidden transform transition-all duration-200 active:scale-[110%] active:shadow-none scale-animation md:hover:shadow-none' >
            ...
            <div className='flex flex-wrap text-white justify-center '>
                <div className='image2 rounded-lg drop-shadow-[0_10px_10px_rgba(0,0,0,0.75)] flex flex-col transform transition-all duration-200 active:scale-[110%] active:shadow-none scale-animation md:hover:shadow-none' onMouseDown={() => changeImage2(upArrow)} onMouseUp={() => changeImage2(downArrow)} >
                ...
                <div className='image2 rounded-lg drop-shadow-[0_10px_10px_rgba(0,0,0,0.75)] flex flex-col transform transition-all duration-200 active:scale-[110%] active:shadow-none scale-animation md:hover:shadow-none' onMouseDown={() => changeImage3(upArrow)} onMouseUp={() => changeImage3(downArrow)} >
                ...
                <div className='image2 rounded-lg drop-shadow-[0_10px_10px_rgba(0,0,0,0.75)] flex flex-col transform transition-all duration-200 active:scale-[110%] active:shadow-none scale-animation md:hover:shadow-none' onMouseDown={() => changeImage4(upArrow)} onMouseUp={() => changeImage4(downArrow)} >
                ...
                <div className='image2 rounded-lg drop-shadow-[0_10px_10px_rgba(0,0,0,0.75)] flex flex-col transform transition-all duration-200 active:scale-[110%] active:shadow-none  scale-animation md:hover:shadow-none' onMouseDown={() => changeImage5(upArrow)} onMouseUp={() => changeImage5(downArrow)} >
                    ...
                    <p   className='game-text absolute rotate-[270deg]' >CRICKET</p>
                </div>
            </div>
        </div>
    </div>
