        ...
        {testimonials.map((testimonial) => (
          ...
          >
            <div className='bg-gray-100 w-full lg:w-[60vw] flex flex-col rounded-lg items-center'>
              <img className='lg:w-[5vw]' src={testimonial.pic} alt="" />
