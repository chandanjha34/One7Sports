...
function Why(){
  return (
    <div className='flex flex-col gap-[1rem] bg-[#E7EEF9]'>
        <div className='text-center'>Our features</div>
        <div className='text-center'>Why Choose One7 Sports?</div>
        <div className='flex flex-col md:flex-row w-[90vw] mx-auto justify-around gap-[3rem] my-[3rem]'>
            <div className='flex flex-col items-center gap-[1rem]'>
                ...
                <div className='text-center font-semibold'>Commitment to Excellence</div>
            ...
            <div className='flex flex-col items-center gap-[1rem]'>
                ...
                <div className='text-center font-semibold'>Inclusive Approach</div>
            ...
            <div className='flex flex-col items-center gap-[1rem]'>
                ...
                <div className='text-center font-semibold'>Technology-Driven Growth</div>
            ...
            <div className='flex flex-col items-center gap-[1rem]'>
                ...
                <div className='text-center font-semibold'>Passion for Sports</div>
