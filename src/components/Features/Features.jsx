...
const FeatureSection = () => {
  return (
    <div className='max-w-screen overflow-hidden w-[100vw] h-auto flex flex-col gap-[2rem]'>
      <div className='xl:translate-y-[4vw] w-[90vw] mx-auto'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 boxes '>
        <div className='grid grid-cols-3 box hover:scale-[105%] transition-transform duration-300'>
          <div className='w-full'><img className='image' src={feature1} alt="" /></div>
        ...
        <div className='grid grid-cols-3 box custom-background text-white hover:scale-[105%] transition-transform duration-300'>
          <div className='w-full'><img className='image' src={feature2} alt="" /></div>
        ...
        <div className='grid grid-cols-3  box hover:scale-[105%] transition-transform duration-300'>
          <div className='w-full'><img className='image' src={feature3} alt="" /></div>
